...
from playwright.async_api import async_playwright, TimeoutError, StorageState
...
class TikTokApi:
    ...
    async def refresh_contexts(self, proxy: dict = None, context_options: dict = {}):
        for sess in self.sessions:
            ...
            sess.context = await self.browser.new_context(proxy=proxy, storage_state=state)
